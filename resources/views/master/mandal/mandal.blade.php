...
<cui-breadcrumb>
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" ng-reflect-ng-class="[object Object]">
      <span tabindex="0" ng-reflect-router-link="//dashboard/">Mandals</span>
    </li>
  </ol>
</cui-breadcrumb>
    ...
    <div class="col-lg-12">
      ...
      <div class="card">
        <div class="search_box house_data">
            <div class="input-group">
               ...
               <a href="javascript:void(0)" id="addNewBook" class="btn btn-outline-primary"><i class="fa fa-plus" style="margin-right: 10px;"></i><span id="btn-user-model">Add Mandal</span></a>
      ...
      <div class="card pen_appr">
        <div class="card-header">
          <i class="fa fa-align-justify"></i>Mandals
        </div>
        <div class="card-body">
