...
<cui-breadcrumb>
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" ng-reflect-ng-class="[object Object]">
      <span tabindex="0" ng-reflect-router-link="//dashboard/">Wards</span>
    </li>
  </ol>
</cui-breadcrumb>
    ...
    <div class="col-lg-12">
      ...
      <div class="card">
        <div class="search_box house_data">
            <div class="input-group">
               ...
               <a href="javascript:void(0)" id="addNewBook" class="btn btn-outline-primary"><i class="fa fa-plus" style="margin-right: 10px;"></i><span id="btn-user-model">Add Ward</span></a>
      ...
      <div class="card pen_appr">
        <div class="card-header">
          <i class="fa fa-align-justify"></i>Wards
        </div>
        <div class="card-body">
              ...
              <tbody id="myTable"> 
                ...
                <tr>
                    ...
                    <td style="text-align: right;">
                      ...
                      <button type="button" data-id="{{ $ward->id }}" class="btn btn-danger delete btn-sm" title="Delete"><i class="fa fa-trash"></i></button>
                    </td>
                </tr>
                @endforeach
              </tbody>
          ...
          <div class="modal-body">
            <form action="javascript:void(0)" id="addEditBookForm" name="addEditBookForm" class="form-horizontal" method="POST">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <select name="parent_id" id="ddl-mandal" class="form-control volunteer">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" id="title" name="name" placeholder="Enter Ward Name" value="" maxlength="50" required="">
                </div>
              </div>  
...
<script type="text/javascript">
 $(document).ready(function($){
    ...
    $('body').on('click', '.edit', function () {
        ...
        $.ajax({
            ...
            success: function(res){
              $('#ajaxBookModel').html("Edit Ward");
              $('#ajax-book-model').modal('show');
              $('#id').val(res.id);
              $('#ddl-mandal').val(res.parent_id);
              $('#title').val(res.name);
           }
        });
    });
    ...
    $('body').on('click', '#btn-save', function (event) {
          let id = $('#id').val();
          var title = $("#title").val();
            let url = "{{ url('add-update-ward') }}";
  
            if(id!=''){
              url = "{{ url('update-ward') }}/"+id;
            }
